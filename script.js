...
function filtrarParticipantes() {
    var input, filtro, select, optgroups, options, i;
    input = document.getElementById("buscarParticipante");
    filtro = input.value.toUpperCase();
    select = document.getElementById("participantes_oficial");
    optgroups = select.getElementsByTagName("optgroup");

    for (var j = 0; j < optgroups.length; j++) {
        options = optgroups[j].getElementsByTagName("option");
        ...
        // Oculta o optgroup se nenhum item for visível
        optgroups[j].style.display = grupoVisivel ? "" : "none";
    }
}
...
const webhookURL = 'https://discord.com/api/webhooks/1344367154031759381/tAD6_-T-Yqkuaq7EV5pLU_Kk8yoCfocFifNHJnnPAPImmB_MAKTPTXnEri1JDpUJ-7DV';
